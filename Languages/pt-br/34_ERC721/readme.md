...
Todo o código e tutoriais estão disponíveis no meu GitHub (1024 estrelas para certificação do curso, 2048 estrelas para NFT do grupo): [github.com/AmazingAng/WTFSolidity](https://github.com/AmazingAng/WTF-Solidity)
